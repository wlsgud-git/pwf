...
:root {
  --pwf-change-mode: 725px;
  /* color */
  --pwf-signiture-color: rgb(49, 48, 48);
  --pwf-white: #fff;
  --pwf-gray: rgb(213, 211, 211);
  --pwf-light-gray: rgb(78, 77, 77);
  --pwf-blue: #0078ff;
  --pwf-red: #b91c1c;
  --pwf-error-color: #fef2f2;
  --pwf-notactive-blue: rgb(62, 62, 180);
