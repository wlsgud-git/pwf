  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = o.arrow) != null && n.alignmentOffset)
        return {};
      const h = ce(i), x = ve(a), E = ce(a) === a, P = await (c.isRTL == null ? void 0 : c.isRTL(u.floating)), b = v || (E || !p ? [Ne(a)] : Gn(a)), S = m !== "none";
...
var Mi = Object.defineProperty, Ri = Object.defineProperties, Di = Object.getOwnPropertyDescriptors, Ft = Object.getOwnPropertySymbols, $i = Object.prototype.hasOwnProperty, Ni = Object.prototype.propertyIsEnumerable, Ut = (e, t, n) => t in e ? Mi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, Y = (e, t) => {
  for (var n in t || (t = {}))
...
function ws(e, t) {
  ...
  if (v) {
    ...
    b.pipe(
      O((S) => {
        const C = p(S.payload);
        return go(C) ? void 0 : se(Y({}, C), { from: S.from });
      }),
      Qe((S) => !!S),
      Nt(u)
    ).subscribe(m);
...
function Rs(e, t) {
  ...
  return r.set(n, c), e.once(y.Disconnected, () => {
...
const Io = M.createContext(void 0);
function zs(e) {
  const t = M.useContext(Io);
  if (e === !0) {
    if (t)
      return t;
...
//# sourceMappingURL=contexts-BPNgUYT_.mjs.map
